  ...
  open({ roomId, from, to, guests }) {
    ...
    const handler = () => {
      try {
        ...
        const policiesAccepted = this.querySelector('#acceptPolicies').checked;
        if (!policiesAccepted) {
          errorMsg.textContent = 'Debes aceptar las políticas para continuar.';
          return;
        }
